 ...
 addEntreprise()
 {
  ...
  if (e === '0') {
    this.entrepriseService.addEnterprise(this.enterprise) 
      ...
      this.exercice.entreprise=this.enterprise;
      this.exercice.excerciceState="INACTIVE"
       this.exerciceService.addExcercice(this.exercice).subscribe(
         data=>{
           this.exercice=data;
           this.content='ajouter  Entreprise  réussi'
